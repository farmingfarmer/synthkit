...
def main():
    ...
    for missing in ("effect curves", "the relationship graph"):
        check("...and the spec says plainly that {} did not cross, "
              "rather than looking complete".format(missing),
              missing in carried["did_not_cross"])
